    ...
    return (
        <div className='w-full h-fit bg-transparent text-center p-2 md:p-3   '>
            ...
            <div className='w-full flex gap-4  align-center justify-center'>
                <button className='mt-7 px-6 py-2 bg-red-500 text-white rounded-xl sm:text-sm md:text-lg xl:text-xl hover:bg-red-400'>Start Your Journey</button>
                <button className='mt-7 px-6 py-2 bg-red-500 text-white rounded-xl sm:text-sm md:text-lg xl:text-xl hover:bg-red-400'>Why Choose Us?</button>
            </div>
